...
for economy in Economy_codes:
    ...
    script_dir = './results/'
    results_dir = os.path.join(script_dir, 'APEC_regional_III')
    ...
    # FED
    ref_fedfuel_1.loc[ref_fedfuel_1['fuel_code'] == 'Electricity', 'fuel_code'] = 'Electricity_ref'
    netz_fedfuel_1.loc[netz_fedfuel_1['fuel_code'] == 'Electricity', 'fuel_code'] = 'Electricity_cn'

    # Select relevant dataframes to put in sheets
    ref_fedfuel_1.to_excel(writer, sheet_name = economy + ' df III', index = False, startrow = 3)
    netz_fedfuel_1.to_excel(writer, sheet_name = economy + ' df III', index = False, startrow = ref_fedfuel_1_rows + 6)
    ...
    ref_worksheet1 = writer.sheets[economy + ' df III']
...
excel_filenames = glob.glob("./results/APEC_regional_III/*.xlsx")

writer3 = pd.ExcelWriter('./results/APEC_regional_III/combined.xlsx', engine = 'xlsxwriter')
