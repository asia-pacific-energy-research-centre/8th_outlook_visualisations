...
for economy in Economy_codes:
    ...
    script_dir = './results/'
    results_dir = os.path.join(script_dir, 'APEC_regional')
    ...
    writer = pd.ExcelWriter(results_dir + '/' + economy + '_regional_data_' + day_month_year + '.xlsx', engine = 'xlsxwriter')
    ...
    # Change varible name in tables below

    # TPES
    ref_tpes_1.loc[ref_tpes_1['fuel_code'] == 'Coal', 'fuel_code'] = 'Coal_tpes_ref'
    ref_tpes_1.loc[ref_tpes_1['fuel_code'] == 'Oil', 'fuel_code'] = 'Oil_tpes_ref'
    ref_tpes_1.loc[ref_tpes_1['fuel_code'] == 'Gas', 'fuel_code'] = 'Gas_tpes_ref'
    ref_tpes_1.loc[ref_tpes_1['fuel_code'] == 'Total', 'fuel_code'] = 'Total_tpes_ref'
    
    netz_tpes_1.loc[netz_tpes_1['fuel_code'] == 'Coal', 'fuel_code'] = 'Coal_tpes_cn'
    netz_tpes_1.loc[netz_tpes_1['fuel_code'] == 'Oil', 'fuel_code'] = 'Oil_tpes_cn'
    netz_tpes_1.loc[netz_tpes_1['fuel_code'] == 'Gas', 'fuel_code'] = 'Gas_tpes_cn'
    netz_tpes_1.loc[netz_tpes_1['fuel_code'] == 'Total', 'fuel_code'] = 'Total_tpes_cn'

    # Prod
    ref_prod_1.loc[ref_prod_1['fuel_code'] == 'Coal', 'fuel_code'] = 'Coal_prod_ref'
    ref_prod_1.loc[ref_prod_1['fuel_code'] == 'Oil', 'fuel_code'] = 'Oil_prod_ref'
    ref_prod_1.loc[ref_prod_1['fuel_code'] == 'Gas', 'fuel_code'] = 'Gas_prod_ref'
    ref_prod_1.loc[ref_prod_1['fuel_code'] == 'Total', 'fuel_code'] = 'Total_prod_ref'
    
    netz_prod_1.loc[netz_prod_1['fuel_code'] == 'Coal', 'fuel_code'] = 'Coal_prod_cn'
    netz_prod_1.loc[netz_prod_1['fuel_code'] == 'Oil', 'fuel_code'] = 'Oil_prod_cn'
    netz_prod_1.loc[netz_prod_1['fuel_code'] == 'Gas', 'fuel_code'] = 'Gas_prod_cn'
    netz_prod_1.loc[netz_prod_1['fuel_code'] == 'Total', 'fuel_code'] = 'Total_prod_cn'

    # Imports
    ref_imports_1.loc[ref_imports_1['fuel_code'] == 'Coal', 'fuel_code'] = 'Coal_imports_ref'
    ref_imports_1.loc[ref_imports_1['fuel_code'] == 'Crude oil & NGL', 'fuel_code'] = 'Crude_imports_ref'
    ref_imports_1.loc[ref_imports_1['fuel_code'] == 'Petroleum products', 'fuel_code'] = 'Petprod_imports_ref'
    ref_imports_1.loc[ref_imports_1['fuel_code'] == 'Gas', 'fuel_code'] = 'Gas_imports_ref'
    ref_imports_1.loc[ref_imports_1['fuel_code'] == 'Total', 'fuel_code'] = 'Total_imports_ref'
    
    netz_imports_1.loc[netz_imports_1['fuel_code'] == 'Coal', 'fuel_code'] = 'Coal_imports_cn'
    netz_imports_1.loc[netz_imports_1['fuel_code'] == 'Crude oil & NGL', 'fuel_code'] = 'Crude_imports_cn'
    netz_imports_1.loc[netz_imports_1['fuel_code'] == 'Petroleum products', 'fuel_code'] = 'Petprod_imports_cn'
    netz_imports_1.loc[netz_imports_1['fuel_code'] == 'Gas', 'fuel_code'] = 'Gas_imports_cn'
    netz_imports_1.loc[netz_imports_1['fuel_code'] == 'Total', 'fuel_code'] = 'Total_imports_cn'

    # Exports
    ref_exports_1.loc[ref_exports_1['fuel_code'] == 'Coal', 'fuel_code'] = 'Coal_exports_ref'
    ref_exports_1.loc[ref_exports_1['fuel_code'] == 'Crude oil & NGL', 'fuel_code'] = 'Crude_exports_ref'
    ref_exports_1.loc[ref_exports_1['fuel_code'] == 'Petroleum products', 'fuel_code'] = 'Petprod_exports_ref'
    ref_exports_1.loc[ref_exports_1['fuel_code'] == 'Gas', 'fuel_code'] = 'Gas_exports_ref'
    ref_exports_1.loc[ref_exports_1['fuel_code'] == 'Total', 'fuel_code'] = 'Total_exports_ref'
    
    netz_exports_1.loc[netz_exports_1['fuel_code'] == 'Coal', 'fuel_code'] = 'Coal_exports_cn'
    netz_exports_1.loc[netz_exports_1['fuel_code'] == 'Crude oil & NGL', 'fuel_code'] = 'Crude_exports_cn'
    netz_exports_1.loc[netz_exports_1['fuel_code'] == 'Petroleum products', 'fuel_code'] = 'Petprod_exports_cn'
    netz_exports_1.loc[netz_exports_1['fuel_code'] == 'Gas', 'fuel_code'] = 'Gas_exports_cn'
    netz_exports_1.loc[netz_exports_1['fuel_code'] == 'Total', 'fuel_code'] = 'Total_exports_cn'

    # Coal
    ref_coalcons_1.loc[ref_coalcons_1['item_code_new'] == 'Total', 'item_code_new'] = 'Total_coalcons_ref'
    netz_coalcons_1.loc[netz_coalcons_1['item_code_new'] == 'Total', 'item_code_new'] = 'Total_coalcons_cn'

    # Gas
    ref_gascons_1.loc[ref_gascons_1['item_code_new'] == 'Total', 'item_code_new'] = 'Total_gascons_ref'
    netz_gascons_1.loc[netz_gascons_1['item_code_new'] == 'Total', 'item_code_new'] = 'Total_gascons_cn'

    # Crude
    ref_crudecons_1.loc[ref_crudecons_1['item_code_new'] == 'Total', 'item_code_new'] = 'Total_crudecons_ref'
    netz_crudecons_1.loc[netz_crudecons_1['item_code_new'] == 'Total', 'item_code_new'] = 'Total_crudecons_cn'

    # Petroleum products
    ref_petprodcons_1.loc[ref_petprodcons_1['item_code_new'] == 'Total', 'item_code_new'] = 'Total_petprodcons_ref'
    netz_petprodcons_1.loc[netz_petprodcons_1['item_code_new'] == 'Total', 'item_code_new'] = 'Total_petprodcons_cn'

    # Select relevant dataframes to put in sheets
    ref_tpes_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = 3)
    netz_tpes_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + 6)
    ref_prod_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + 9)
    netz_prod_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + 12)
    ref_imports_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + 15)
    netz_imports_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + ref_imports_1_rows + 18)
    ref_exports_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + ref_imports_1_rows + netz_imports_1_rows + 21)
    netz_exports_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + ref_imports_1_rows + netz_imports_1_rows + ref_exports_1_rows + 24)
    ref_coalcons_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + ref_imports_1_rows + netz_imports_1_rows + ref_exports_1_rows + netz_exports_1_rows + 27)
    netz_coalcons_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + ref_imports_1_rows + netz_imports_1_rows + ref_exports_1_rows + netz_exports_1_rows + ref_coalcons_1_rows + 30)
    ref_gascons_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + ref_imports_1_rows + netz_imports_1_rows + ref_exports_1_rows + netz_exports_1_rows + ref_coalcons_1_rows + netz_coalcons_1_rows + 33)
    netz_gascons_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + ref_imports_1_rows + netz_imports_1_rows + ref_exports_1_rows + netz_exports_1_rows + ref_coalcons_1_rows + netz_coalcons_1_rows + ref_gascons_1_rows + 36)
    ref_crudecons_1.to_excel(writer, sheet_name = economy + ' dfI', index = False, startrow = ref_tpes_1_rows + netz_tpes_1_rows + ref_prod_1_rows + netz_prod_1_rows + ref_imports_1_rows + netz_imports_1_rows + ref_exports_1_rows + netz_exports_1_rows + ref_coalcons_1_rows + netz_coalcons_1_rows + ref_gascons_1_rows + netz_gascons_1_rows + 39)
    ...
    ref_worksheet1 = writer.sheets[economy + ' dfI']
    ...
    ref_worksheet1.set_column(1, ref_tpes_1_cols + 1, None, space_format)
    #ref_worksheet1.set_row(chart_height, None, header_format)
    ref_worksheet1.write(0, 0, economy + ' select dataframes REF and CN', cell_format1)
